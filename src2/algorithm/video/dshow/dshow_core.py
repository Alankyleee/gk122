...
# Embedded file name: algorithm\video\dshow\dshow_core.py
...
from algorithm.video.dshow.moniker import IEnumMoniker
from algorithm.video.dshow.win_common_types import DWORDLONG, LONG_PTR, OLE_HANDLE, REFERENCE_TIME, REFIID
...
ISampleGrabber._methods_ = [
 ...
 COMMETHOD([], HRESULT, "SetCallback", ([], POINTER(qedit.ISampleGrabberCB), "pCallback"), ([], c_int, "WhichMethodToCallback"))]
...
# okay decompiling D:\gk122\pyi\dlgpy.exe_extracted\PYZ-00.pyz_extracted\algorithm\video\dshow\dshow_core.pyc
